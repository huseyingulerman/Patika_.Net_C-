 ...
 */
            ...
            double averageasal = CalculateAverage(asal);
            double averageasalolmayan = CalculateAverage(asal);
            ...
            Console.WriteLine("Asal olmayan sayıların ortalaması: " + averageasalolmayan);
            ...
            static double CalculateAverage(ArrayList list)
            {
                ...
                {
                    if (item is IConvertible)  // Sayısal türleri kontrol et
                    {
